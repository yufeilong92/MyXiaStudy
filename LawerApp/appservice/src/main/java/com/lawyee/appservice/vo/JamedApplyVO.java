...
public class JamedApplyVO extends BaseVO {
    ...
    public boolean isTyjType() {
        return tyjType;
    }

    public void setTyjType(boolean tyjType) {
        this.tyjType = tyjType;
    }

    public void setTyjType(String tyjType) {
        this.tyjType = JavaLangUtil.StrToBool(tyjType,false);
    }
}
