...
public class Constants extends net.lawyee.mobilelib.Constants {
	 ...
	 * 地图图片地址
	 */
	public static final String MAP_ADDRESS_1= "http://api.map.baidu.com/staticimage?center=";
	public static final String MAP_ADDRESS_2 = "&zoom=15&width=480&height=320&markers=";
	public static final String MAP_ADDRESS_JOINT= "%2C";
	public static final String MAP_ADDRESS_3= "&markerStyles=l%2CA";
