...
public class JalawLawyerEntrustDetailVO extends JalawLawyerEntrustVO {
	 ...
	 */
	private int evaluateLawfirmScore;
	/**
	 *对律所评价内容
	 */
	 ...
	 */
	private int evaluateLawyerScore;
	/**
	 *对律师评价内容
	 */
	...
	public int getEvaluateLawfirmScore() {
		return evaluateLawfirmScore;
	}

	public void setEvaluateLawfirmScore(int evaluateLawfirmScore) {
	...
	public int getEvaluateLawyerScore() {
		return evaluateLawyerScore;
	}

	public void setEvaluateLawyerScore(int evaluateLawyerScore) {
