...
public class JaauthOrgRlvAdapter extends BaseRecyclerAdapter<JaauthOrgRlvAdapter.ViewHolder> implements View.OnClickListener {


    private List<JaauthOrgVO> mData;
    private Context mContext;
    private LayoutInflater mInflater;

    public JaauthOrgRlvAdapter(List<JaauthOrgVO> mData, Context mContext) {
        this.mData = mData;
        this.mContext = mContext;
        mInflater = LayoutInflater.from(mContext);
    }

    public void insent(JaauthOrgVO orgVO,int postion){
    ...
    public void onClick(View v) {
        if (itemClickListener != null) {
            itemClickListener.ItemClickListenet(v, (JaauthOrgVO) v.getTag(),v.getId());
        }
    }

    public interface OnRecyclerViewItemClickListener {
        void ItemClickListenet(View view, JaauthOrgVO vo, int position);
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position, boolean isItem) {
        JaauthOrgVO vo = mData.get(position);
