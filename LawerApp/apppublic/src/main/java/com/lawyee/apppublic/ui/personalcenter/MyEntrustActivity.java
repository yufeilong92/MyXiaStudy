...
public class MyEntrustActivity extends BaseActivity {
    ...
    private void setReAdpater() {
        mAdpater = new MyEntrustAdpater(mJalawLawyerEntrustVOs, mContext,false);
    ...
    private void loadNewData() {
        ...
        service.getJalawEntrustList(1,new BaseJsonService.IResultInfoListener() {
            @Override
    ...
    private void loadMoreData() {
        ...
        setInProgess(true);
        UserService service = new UserService(mContext);
        service.getJalawEntrustList(getNowPage()+1,new BaseJsonService.IResultInfoListener() {
            @Override
            public void onComplete(ArrayList<Object> values, String content) {
                setInProgess(false);
                if(values==null||values.isEmpty()) {
