...
public class RosterProvider extends ContentProvider {
	public static final String AUTHORITY = "com.lawyee.apppublic.provider.Roster";
	...
	public static final class RosterConstants implements BaseColumns {
		...
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.wuzhuim.roster";
		public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.wuzhuim.roster";
		 ...
		 * 好友变更类型-其他
		 */
		public static final int CINT_ROSTER_CHANGETYEP_NONE = 0;
		/**
		 * 好友变更类型-添加好友
		 */
		public static final int CINT_ROSTER_CHANGETYEP_ADD = 1;
		/**
		 * 好友变更类型-删除好友
		 */
		public static final int CINT_ROSTER_CHANGETYEP_DEL = 2;
		/**
		 * 好友变更类型-好友信息更新
		 */
		public static final int CINT_ROSTER_CHANGETYEP_UPDATE = 3;
		/**
		 * 好友状态变更-好友上线
		 */
		public static final int CINT_ROSTER_CHANGETYEP_PRESENCE_AVAILABLE = 4;
		/**
		 * 好友状态变更-好友下线
		 */
		public static final int CINT_ROSTER_CHANGETYEP_PRESENCE_UNAVAILABLE = 5;
		/**
		 * 好友状态变更值-好友上线
		 */
		public static final String CSTR_ROSTER_PRESENCE_AVAILABLE="available";
		/**
		 * 好友状态变更值-好友下线
		 */
		public static final String CSTR_ROSTER_PRESENCE_UNAVAILABLE="unavailable";
