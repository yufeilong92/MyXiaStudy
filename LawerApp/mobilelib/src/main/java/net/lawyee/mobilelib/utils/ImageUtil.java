...
public class ImageUtil 
{
	...
	{
		if(StringUtil.isEmpty(imageUrl)||imageUrl.length()<4)
		{
			String tempfilename = TimeUtil.dateToString(null, "yyyyMMddHHmmss")
					+ ".jpg";
			String filepath = Constants.getDataStoreDir(c) + Constants.CSTR_IMAGECACHEDIR;
		...
		//特殊处理如<img src=\"http://202.98.194.56:8888/quick4w/website/systools/readImage.q4w?id=85e794e9d32f4fe8b9b3c6074912ec8f\" title=\"法创.png\"
		String tmpfilename = FileUtil.getFileName(imageUrl);
