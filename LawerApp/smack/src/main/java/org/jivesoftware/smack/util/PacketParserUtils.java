...
public class PacketParserUtils {
    ...
    public static Message parseMessage(XmlPullParser parser)
        ...
        message.setBusinessId(parser.getAttributeValue("", "businessId"));
        message.setUsername(parser.getAttributeValue("", "userName"));
        message.setConsultType(parser.getAttributeValue("", "consultType"));
        message.setStaffId(parser.getAttributeValue("", "staffId"));
        message.setStaffName(parser.getAttributeValue("", "staffName"));
