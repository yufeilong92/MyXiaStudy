...
public enum DisplayRules {
    ...
    KJEMOJI55("[微笑]", 0xF0, 0x9F, 0x94, 0xA8),
    KJEMOJI56("[微笑]", 0xF0, 0x9F, 0x94, 0xAD),
    KJEMOJI57("[微笑]", 0xF0, 0x9F, 0x94, 0xB0),
    KJEMOJI58("[微笑]", 0xF0, 0x9F, 0x94, 0xA9),
    KJEMOJI59("[微笑]", 0xF0, 0x9F, 0x94, 0xAA),
    KJEMOJI60("[微笑]", 0xF0, 0x9F, 0x94, 0xAB),
    KJEMOJI63("[微笑]", 0xF0, 0x9F, 0x94, 0xB1),
    KJEMOJI64("[微笑]", 0xF0, 0x9F, 0x94, 0xB2),
    KJEMOJI65("[微笑]", 0xF0, 0x9F, 0x94, 0xB3),
    KJEMOJI66("[微笑]", 0xF0, 0x9F, 0x94, 0xB5),
    KJEMOJI67("[微笑]", 0xF0, 0x9F, 0x94, 0xB7),
    KJEMOJI68("[微笑]", 0xF0, 0x9F, 0x94, 0x80),
    KJEMOJI69("[微笑]", 0xF0, 0x9F, 0x94, 0x87),
    KJEMOJI71("[微笑]", 0xF0, 0x9F, 0x94, 0x8E),
    KJEMOJI72("[微笑]", 0xF0, 0x9F, 0x94, 0x90),
    KJEMOJI73("[微笑]", 0xF0, 0x9F, 0x94, 0x91),
    KJEMOJI74("[微笑]", 0xF0, 0x9F, 0x94, 0x95),
    KJEMOJI75("[微笑]", 0xF0, 0x9F, 0x94, 0x97),
    KJEMOJI76("[微笑]", 0xF0, 0x9F, 0x94, 0x81),
    KJEMOJI77("[微笑]", 0xF0, 0x9F, 0x94, 0x9B),
    KJEMOJI78("[微笑]", 0xF0, 0x9F, 0x94, 0x9F),
    KJEMOJI79("[微笑]", 0xF0, 0x9F, 0x94, 0xA6),
    KJEMOJI80("[微笑]", 0xF0, 0x9F, 0x94, 0xA7),
    KJEMOJI81("[微笑]", 0xF0, 0x9F, 0x94, 0xAC),
    KJEMOJI82("[微笑]", 0xF0, 0x9F, 0x94, 0xAE),
    KJEMOJI83("[微笑]", 0xF0, 0x9F, 0x94, 0xAF),
    KJEMOJI84("[微笑]", 0xF0, 0x9F, 0x94, 0xB4),
